        ...
        <section className=" ">
          <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
            ...
            <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700 dark:divide-gray-300">
              <details>
                <summary className="py-2 outline-none cursor-pointer focus:underline mb-2 text-lg font-semibold sm:text-xl title-font dark:text-gray-800">
                  How can I create an account on StudyHub?
                </summary>
                <div className="px-4 pb-4">
                  <p className="text-base leading-relaxed text-gray-400 dark:text-gray-600">
